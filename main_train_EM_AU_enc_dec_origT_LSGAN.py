...
def main(cfg):
    ...
    # deca model
    #train with AU
    from decalib.deca_EM_AU_enc_dec_origT_adv_LSGAN import DECA
    from decalib.trainer_EM_AU_enc_dec_origT_adv_LSGAN import Trainer
    #train origin DECA
...
if __name__ == '__main__':
    ...
    cfg = parse_args(cfg_name='configs/release_version/deca_detail_LSGAN.yml')
