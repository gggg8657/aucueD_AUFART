...
class DecaModule(LightningModule):
    ...
    def encode(self, batch, training=False) -> dict:
        """
        ...
        codedict = {}
        try : 
            original_batch_size = batch['image_224'].shape[0]
            images = batch['image_224']
            images = images.cuda()
        except : 
        ...
        if self.mode == DecaMode.DETAIL:
            # all_detailcode, detail_features = self.deca.E_detail(images)
            all_detailcode, detail_features = self.deca.E_detail(images, output_features=True)
        ...
        codedict['detail_features'] = detail_features
        if self.mode == DecaMode.DETAIL:
        ...
        return codedict, codedict['expcode']
    ...
    def decode(self, codedict, training=True, render=True, **kwargs) -> dict:
        ...
        return codedict, codedict,codedict['predicted_detailed_image']
