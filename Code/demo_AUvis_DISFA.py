...
from decalib.deca_orig import DECA as GATFAREC
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--inputpath', default='./paths.txt', type=str,
    ...
    parser.add_argument('-s', '--savefolder', default='TestSamples/examples/v4/', type=str,
                        help='path to the output directory, where results(obj, txt files) will be stored.')
    # parser.add_argument('--videoName', default='resultWithoutTC.avi', type=str,)
    parser.add_argument('--pretrained_modelpath', default='/mnt/hdd/DJ_Training/vamos/AU_Loss_MEFARG_feature_loss_and_dispparam/model.tar', type=str, help='model.tar path')
