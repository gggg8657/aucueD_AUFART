    ...
    def training_step(self, batch, batch_nb, training_type='coarse'):
        ...
        if not self.train_detail:
            ...
            if self.cfg.loss.weightedAU:
                ...
                # losses['au_feat_loss'] = (1 - F.cosine_similarity(rend_au[2].flatten(), image_au[2].flatten(), dim=0))*self.cfg.loss.subAU
                # pred_au = codedict['pred_au']
                # losses['au_pred_loss'] = F.mse_loss(image_au[1], pred_au[1])
