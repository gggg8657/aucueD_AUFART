...
if __name__ == '__main__':
    ...
    # parser.add_argument('-i', '--inputpath', default='/mnt/hdd/dataset/DISFA/LeftVideoSN002_comp_sequence/1_1/', type=str,
    ...
    parser.add_argument('-i', '--inputpath', default='/home/cine/Downloads/webkhj.jpg', type=str,
    # parser.add_argument('-i', '--inputpath', default='/mnt/hdd/Downloads/woman_SR_sequence/1_1/', type=str,
                        help='path to the test data, can be image folder, image path, image list, video')
    parser.add_argument('-s', '--savefolder', default='videoResult/testGATE29/', type=str,
