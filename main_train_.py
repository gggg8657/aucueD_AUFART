...
def main(cfg):
    ...
    # deca model
    #train with AU
    from decalib.deca_AU_ import DECA
    from decalib.trainer_AU_ import Trainer
    #train origin DECA
...
if __name__ == '__main__':
    ...
    cfg = parse_args(cfg_name='configs/release_version/deca_detail_AU_Loss_weight_tunned.yml')
