...
class Trainer(object):
    ...
    def configure_optimizers(self):
        if self.train_detail:
            self.opt = torch.optim.Adam(
                                ...
                                list(self.deca.AU_D_detail.parameters()) + \
                                list(self.deca.AU_Encoder.parameters()), #+ \
                                # list(self.deca.Encoder.parameters()) ,
    ...
    def training_step(self, batch, batch_nb, training_type='coarse'):
        ...
        ###--------------- training detail model
            ...
            uv_z_1 = self.deca.D_detail(torch.cat([codedict['pose'][:,3:], codedict['exp'], codedict['detail']], dim=1))
            uv_z_2 = self.deca.AU_D_detail(codedict['afn'])
            uv_z = (uv_z_1 + uv_z_2)/2
            # render detail
            ...
            losses['AU_feature'] = F.mse_loss(img_afn, rend_afn)*100 
