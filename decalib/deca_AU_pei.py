...
from .models.encoders_au_ import AUEncoder
...
class DECA(nn.Module):
    ...
    # @torch.no_grad()
    def decode(self, codedict, codedict_emoca rendering=True, iddict=None, vis_lmk=True, return_vis=True, use_detail=True,
        ...
        _, landmarks2d_emoca, landmarks3d_emoca = self.flame(shape_params=codedict_emoca['shape'], expression_params=codedict_emoca['exp'], pose_params=codedict_emoca['pose'])
        ...
        landmarks2d_emoca = util.batch_orth_proj(landmarks2d_emoca, codedict_emoca['cam'])[:,:,:2]; landmarks2d_emoca[:,:,1:] = -landmarks2d_emoca[:,:,1:]#; landmarks2d = landmarks2d*self.image_size/2 + self.image_size/2
        landmarks3d_emoca = util.batch_orth_proj(landmarks3d_emoca, codedict_emoca['cam']); landmarks3d_emoca[:,:,1:] = -landmarks3d_emoca[:,:,1:] #; landmarks3d = landmarks3d*self.image_size/2 + self.image_size/2
        ...
        opdict = {
            ...
            'landmarks2d_emoca': landmarks2d_emoca,
            'landmarks3d_emoca': landmarks3d_emoca,
        ...
        if return_vis and render_orig and original_image is not None and tform is not None:
            ...
            landmarks2d_emoca = transform_points(landmarks2d_emoca, tform, points_scale, [h, w])
            landmarks3d_emoca = transform_points(landmarks3d_emoca, tform, points_scale, [h, w])
        ...
        if return_vis:
            ...
            visdict = {
                ...
                'landmarks2d_emoca': util.tensor_vis_landmarks(images, landmarks2d_emoca),
                'landmarks3d_emoca': util.tensor_vis_landmarks(images, landmarks3d_emoca),
