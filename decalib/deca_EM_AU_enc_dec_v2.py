...
from .models.decoders_AU_dec import Generator, Generator2
...
class DECA(nn.Module):
    ...
    def _create_model(self, model_cfg):
        ...
        self.DAT = TDC(detail_dim=181, au_dim=41, nhid=256, noutput=181, nfeat=512,
    ...
    def encode(self, images, batch, use_detail=True):
        ...
        if use_detail:
            ...
            try : 
                ...
                # codedict['detailcode'] = self.emoca.deca.E_detail(images)
            except : 
        ...
        if use_detail:
            ...
            codedict['detailcode'] = self.E_detail(images)
            posecode = codedict['posecode']
            codedict['global_feature'] = torch.cat([posecode[:,3:], codedict['expcode'], codedict['detailcode']], dim=1)
            # codedict['detail_features'] = self.E_detail(images)
            codedict['detail_input'] = self.DAT(codedict['afn'],codedict['global_feature'])
