...
from .models.decoders_AU_dec_adv import Generator, Generator2, Generator3, Generator4,ConditionalDiscriminator, Generator5, AUConditionalDiscriminator
...
class DECA(nn.Module):
    ...
    def _create_model(self, model_cfg):
        ...
        self.D_detail = Generator5().to(self.device)

        #discriminator
        self.D = AUConditionalDiscriminator().to(self.device)
    ...
    def decode(self, codedict, rendering=True, iddict=None, vis_lmk=True, return_vis=True, use_detail=True,
        ...
        if use_detail:
            ...
            uv_z = self.D_detail( codedict['detailcode'], codedict['afn']) # v1
