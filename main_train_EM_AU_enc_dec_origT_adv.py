...
def main(cfg):
    ...
    # deca model
    #train with AU
    from decalib.deca_EM_AU_enc_dec_origT_adv import DECA
    from decalib.trainer_EM_AU_enc_dec_origT_adv import Trainer
    #train origin DECA
...
if __name__ == '__main__':
    ...
    cfg = parse_args(cfg_name='configs/release_version/deca_detail_EM_AU_enc_dec_hptune_v1_origT_archidiff_auparamadded.yml')
